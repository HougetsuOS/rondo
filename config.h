...
typedef enum { BAR_WIDGET_WS, BAR_WIDGET_TITLE, BAR_WIDGET_LAYOUT, BAR_WIDGET_CLOCK, BAR_WIDGET_LOAD, BAR_WIDGET_MEM, BAR_WIDGET_DISK, BAR_WIDGET_BAT, BAR_WIDGET_VOL, BAR_WIDGET_CPU, BAR_WIDGET_NET, BAR_WIDGET_TEMP } BarWidgetType;
